...
class Migration(migrations.Migration):
    dependencies = [
        ('scheduler', '0002_event_color_event'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(help_text='This date is ignored for one time only events.', null=True,
                                       verbose_name='end recurring period', db_index=True, blank=True),
        ),
        migrations.AlterField(
            model_name='event',
            name='start',
