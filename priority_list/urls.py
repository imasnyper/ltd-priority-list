"""priority_list URL Configuration
...
urlpatterns = [
    ...
    path(
        "accounts/login/",
        auth_views.LoginView.as_view(authentication_form=MyLoginForm),
        name="login",
    ),
    path("accounts/logout/", auth_views.LogoutView.as_view(), name="logout"),
    path(
        "accounts/password_change/",
        auth_views.PasswordChangeView.as_view(form_class=MyPasswordChangeForm),
