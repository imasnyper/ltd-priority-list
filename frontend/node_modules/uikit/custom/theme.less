...
@table-striped-row-background:                  darken(@global-muted-background, 10%);
@card-default-background:                       darken(@global-muted-background, 5%);

hook-card() {box-shadow: 5px, 5px, black}